...
function MD5Stream(TmpStream:TMemoryStream):MD5Digest;

function MD5Print(D: MD5Digest): string;

function md5encodeStream(TmpStream:TMemoryStream):String;
function md5encodefile(sTmpStr:WideString):String;
function md5encode(sTmpStr:WideString):String;
...
begin
  ...
  MD5Update(Context, TmpStream.Memory, TmpStream.Size);
	MD5Final(Context, Result);
end;

function md5encodeStream(TmpStream:TMemoryStream):string;
begin
  Result:=MD5Print(MD5Stream(TmpStream));
end;

function md5encodefile(sTmpStr:WideString):String;
begin
  Result:=MD5Print(MD5File(sTmpStr));
end;

function md5encode(sTmpStr:WideString):String;
begin
  Result:=MD5Print(MD5String(sTmpStr));
end;
