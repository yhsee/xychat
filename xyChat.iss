...
Source: "GIPSVoiceEngine.dll";         DestDir: "{app}"; Flags: ignoreversion  uninsneveruninstall onlyifdoesntexist
...
Source: "mpeg4\*.*";                   DestDir: "{app}\mpg4";        Flags: ignoreversion
...
[Icons]
Name: "{group}\奕信 2012";       Filename: "{app}\xyChat.exe" ;WorkingDir: "{app}"
Name: "{group}\卸载奕信 2012";   Filename: "{uninstallexe}" ;    WorkingDir: "{app}"
Name: "{userdesktop}\奕信 2012"; Filename: "{app}\xyChat.exe"; WorkingDir: "{app}"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\奕信 2012"; Filename: "{app}\xyChat.exe"; WorkingDir: "{app}"


[Run]
Filename: "{app}\mpg4\install.bat"; Description: "安装Microsoft MPEG-4编码解码器,视频所必需!"; Flags: nowait runhidden postinstall skipifsilent
