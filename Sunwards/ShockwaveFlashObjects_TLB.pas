...
// PASTLWTR : 1.2
// File generated on 2007-5-22 17:13:30 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\WINDOWS\system32\Macromed\Flash\Flash9b.ocx (1)
...
// *********************************************************************//
  ...
  TOnLMouseDownEvent = procedure(ASender: TObject) of object;                                                         
  ...
  private
    ...
    FOnLMouseDown: TOnLMouseDownEvent;
  ...
  published
    ...
    property OnLMouseDown: TOnLMouseDownEvent read FOnLMouseDown write FOnLMouseDown;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if Assigned(FOnLMouseDown) then
          FOnLMouseDown(Self);
